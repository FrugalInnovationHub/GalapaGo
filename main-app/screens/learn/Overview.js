      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.spaceP}>
              ...
              <ListItem>
                <View>
                  <Text style={styles.dropBodyText}>
                    In the airports of Quito and Guayaquil prior to the check-in
                    with your airline you must:{"\n"}
                    {"\n"}
                    <Text style={{ fontWeight: "bold" }}>Step 1:</Text> Register
                    with the Galapagos Government Council Office to obtain your
                    Transit Control Card (TCT) cost of the TCT is $20.00{"\n"}
                    {"\n"}
                    <Text
                    ...
                    Baltra and San Cristobal airports: As an entrance tax to the
                    protected areas of Galapagos, an entrance tax will be
                  ...
                  <Text style={styles.dropBodyText}>
                    ...
                    inspector from the Agency for the Regulation and Control of
                    Biosecurity for Galapagos will check your suitcase to make
                    sure that no organic products that may bring organisms that
                    threaten the Galapagos ecosystems are entering.
                  </Text>
                </View>
              </ListItem>
            </CollapseBody>
              ...
              <ListItem>
                <View>
                  <Text style={styles.dropBodyText}>
                    ...
                    {"\n"}
                    {"\n"}
                    <Text style={{ fontWeight: "bold" }}>Step 1:</Text> You need
                    to buy a Lobito ticket for the bus ($5.00) The bus will take
                    you from Baltra airport to the Canal Itabaca, which
                    separates the islands of Baltra and Santa Cruz, this tour
                    ...
                    {"\n"}
                    {"\n"}
                    <Text style={{ fontWeight: "bold" }}>Step 3:</Text> Once on
                    the island of Santa Cruz, to get to Puerto Ayora, there are
                    two options: {"\n"}
                  </Text>
                  <Text style={styles.sublist}>
                    ...
                    capacity of 4 passengers It costs $25 for all occupants and
          ...
          <Text style={styles.bodyText}>
            <Text style={{ fontWeight: "bold" }}>
              Guidelines for the entry of tourists to the province of Galapagos,
              in the context of the Health emergency due to Covid-19
            </Text>
            {"\n"}
            {"\n"}
