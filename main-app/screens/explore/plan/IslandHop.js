          ...
          <View style={{ backgroundColor: "white", flex: 1 }}>
            ...
            <View style={styles.numberRow}>
              ...
              <TouchableOpacity
                style={{ flexDirection: "row" }}
                onPress={() =>
                  Linking.openURL("mailto:ventas@santafegalapagos.com.ec")
                }
              >
                <Image
              ...
              <TouchableOpacity
                style={{ flexDirection: "row" }}
                onPress={() =>
                  Linking.openURL("https:yacht.santafegalapagos.com.ec")
                }
              >
                <Image
            ...
            <View style={styles.numberRow}>
              ...
              <TouchableOpacity
                style={{ flexDirection: "row" }}
                onPress={() =>
                  Linking.openURL("mailto:kmartinez@oagalapagos.com")
                }
              >
                <Image
                  source={require("../../../app/assets/icons/email.png")}
              ...
              <TouchableOpacity
                style={{ flexDirection: "row" }}
                onPress={() =>
                  Linking.openURL("https:www.oceanadventures.com.ec")
                }
              >
                <Image
                  source={require("../../../app/assets/icons/www_gray.png")}
            ...
            <View style={styles.numberRow}>
              ...
              <TouchableOpacity
                style={{ flexDirection: "row" }}
                onPress={() =>
                  Linking.openURL("mailto:haguirre@xpedition.com.ec")
                }
              >
                <Image
                  source={require("../../../app/assets/icons/email.png")}
              ...
              <TouchableOpacity
                style={{ flexDirection: "row" }}
                onPress={() =>
                  Linking.openURL("https:www.celebritycruises.com")
                }
              >
                <Image
                  source={require("../../../app/assets/icons/www_gray.png")}
            ...
            <View style={styles.numberRow}>
              ...
              <TouchableOpacity
                style={{ flexDirection: "row" }}
                onPress={() =>
                  Linking.openURL("mailto:ebrito@metropolitan-touring.com")
                }
              >
                <Image
                  source={require("../../../app/assets/icons/email.png")}
            ...
            <Text style={styles.regularBold}>
              M/N National Geographic Islander
            </Text>
            <Swiper style={styles.wrapper} showsButtons={true}>
              <View style={styles.slide}>
                <Image
