    ...
    return (
      <ScrollView style={{ backgroundColor: "white", flex: 1 }}>
        ...
        <Text style={styles.bodyText}>
          Internet connection can be obtained in all places of accommodation /
          restaurants. The internet in Puerto Ayora is satellite, therefore we
          do not have a fiber optic connection which can make it slow.
        </Text>
