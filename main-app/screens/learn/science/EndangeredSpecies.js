  ...
  render() {
    return (
      <SafeAreaView style={styles.container}>
        <ScrollView>
          <LearnHeader
            subTitle="Science and Sustainability / EndangeredSpecies"
            goBack={() => {
          ...
          <Text style={styles.regular}>
            In 2018, a list was created with the endangered species, among which
            we find:{" "}
          </Text>
          ...
          <Text style={styles.regular}>
            The causes of this phenomenon are diverse, ranging from illegal
            hunting, the introduction of alien species to the islands, the
            unconsciousness of certain tourists and inhabitants of the area, to
            climate change that generates harmful variations in the levels of
            oxygen and other gases at the bottom of the sea.
          </Text>
        </ScrollView>
      </SafeAreaView>
    );
