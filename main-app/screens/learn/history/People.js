      ...
      <ScrollView style={styles.container}>
        <View>
          ...
          <Text style={styles.bodyText}>
            ...
            income. The archipelago currently receives 175,000 visitors a year.
            The second economic activity is artisanal fishing, the fishing
            sector is the most involved in the management of the Marine Reserve.
            Artisanal fishermen represent an important group in the economy. In
            recent years, the artisanal ability of the island's inhabitants has
            developed significantly.{"\n\n"}
            The use of recycled materials, t-shirt painting and wood carving is
            unique. Agricultural activities in the islands are not very
            technical, natural products grown organically are brought from the
            humid areas of the upper parts of the archipelago to be consumed in
            the ports.{"\n\n"}
